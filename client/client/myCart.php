...
<script>
    ...
    function calculatePrice() {
        ...
        ShippingChargeEle.innerHTML = `<i class='fa fa-rupee'></i> ${ShippingCharge}`;
        GSTEle.innerHTML = `<i class='fa fa-rupee'></i> ${GST}`;
...
if($result = mysqli_query($conn, $getCartProducts)) {
    ...
    echo "<div class='mainContainer'>";
        echo "<div class='productsInCartContainer'>";
    ...
    <div class='addressBox'>
        ...
        <div class='form-input'>
            ...
            <input type='text' name='name' id='name' placeholder='Enter Your Name here' autocomplete='none' required>
        </div>
        <div class='form-input'>
            <label for='email'>Email Address: </label>
            <input type='email' name='email' id='email' placeholder='Enter Your Email' autocomplete='none' required>
        </div>
        <textarea class='block' name='delivaryAddress' id='addressBox' autocomplete='none'  cols='20' rows='6' placeholder='Enter the delivary address' required></textarea>
